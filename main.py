...
class AUFR(QMainWindow):  # Main application
    ...
    def __init__(self):
        ...
        self.setWindowTitle("He thong diem danh dua tren nhan dien khuon mat ")
    ...
    def about_info(self):  # Menu Information of info button of application.
        ...
        msg_box.setText('''
            ...
            Cảm ơn sự giúp đỡ của thầy giúp bọn em hoàn thành bài tập này
        ''')
        msg_box.setInformativeText('''
            Học Viện Kỹ Thuật Mật Mã
            Thị Giác Máy Tính - C2N02
